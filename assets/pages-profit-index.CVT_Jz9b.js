import { _ as t } from './BannerView.vue_vue_type_script_setup_true_lang.rywTHav6.js';
import {
  d as e,
  c as a,
  a as s,
...
import { _ as w } from './GradientText.vue_vue_type_script_setup_true_lang.BkTL9yzF.js';
import { _ as j } from './PyTitle.BjzIl1Sf.js';
import { f as C } from './index.F-ZonE96.js';
import { u as M, _ as P } from './usePaged.B5F6NsN_.js';
import { b as S, _ as E, a as I } from './wd-tab.Yv1_Q-tw.js';
    ...
    setup(e) {
      ...
      const { list: x } = M(async function (t) {
        ...
        const e = await k.app.getOrderPage({ params: { type: 2, ...t } }),
          { code: a, data: s } = e || {};
        if (0 !== a || !s) throw new Error('获取数据失败');
        const { list: r } = s;
        return (
          (r || []).forEach((t) => {
            const e = [];
